...
class ImportAllHotelsCommand extends AbstractCommand
{
    protected function configure()
    {
        $this
            ->setName('app:import-all-hotels')
            ->setDescription('Import ALL hotels from travel project into Pimcore data objects');
    }

    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        // Complete hotel data array from TypeScript
        $hotels = $this->getAllHotels();

        $output->writeln('<info>Starting complete hotel import...</info>');
        ...
        foreach ($hotels as $hotelData) {
            try {
                ...
                // Set localized fields for all required locales
                ...
                $successCount++;
                $output->writeln('<info>✓ Successfully processed: ' . $hotelData['name'] . '</info>');
        ...
        $output->writeln('<info>Successfully processed: ' . $successCount . ' hotels</info>');
        $output->writeln('<info>Updated existing: ' . $updatedCount . ' hotels</info>');
