...
\Pimcore\Bootstrap::bootstrapCli();
...
try {
    ...
    foreach ($destinations as $destination) {
        ...
        if (file_exists($sourceFile)) {
            ...
            echo "Warning: Image not found: $sourceFile\n";
        }
    }
    ...
    foreach ($destinations as $data) {
        ...
        if ($existingObject) {
            echo "Destination already exists: " . $data['name'] . "\n";
            continue;
        }
        ...
        $destination->save();
        echo "Created destination: " . $data['name'] . "\n";
    }
    
    echo "\n✅ Import completed successfully!\n";
    echo "Created " . count($destinations) . " destinations in /Destinations\n";
    echo "Uploaded images to /Assets/Destinations\n";
